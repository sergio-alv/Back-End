...
public class seguimientoController {
  ...
  // Lista todas los seguimientos sobre una venta recibiendo como parámetros obligatorios el número de la venta.
	...
	public List<seguimiento> listarSeguimientosUsuario(@RequestParam("usuario") String usuario) {
  ...
  public int cantidadSeguidosUsuario(@RequestParam("usuario") String usuario){
